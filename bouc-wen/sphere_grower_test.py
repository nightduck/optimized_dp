...
from sphere_grower import SphereGrower
import math
import os
...
Initial_value_f = np.sqrt(g.vs[0]**2 + g.vs[1]**2 + g.vs[2]**2) - 3
...
sys3D = SphereGrower(x=[0,0,0], uMin = [-1], uMax = [1], dMin = [0], dMax = [0], uMode="max", dMode="min")
...
# %%
# print("Center values: ", value_fn[4:-4,4:-4,4:-4,-2])
# STEP 7: Plotting
# Run marching cubes
try:
